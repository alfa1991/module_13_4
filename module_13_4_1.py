...
async def start(message: Message):
    await message.answer('Привет! Я бот, помогающий твоему здоровью. Введите "Calories", чтобы начать расчет нормы калорий.')
...
async def all_messages(message: Message):
    await message.answer('Пожалуйста, используйте команду /start или введите "Calories", чтобы продолжить.')
